...
def _make_additional_pipeline_args(exec_properties: Dict[Text, Text]
                                  ) -> Dict[Text, Any]:
  ...
  Args:
    exec_properties: Execution properties for the component.

  Returns:
    Dictionary containing `additional_pipeline_args`.
  """
  beam_pipeline_args = exec_properties.get('beam_pipeline_args', [])
  ...
  return {'beam_pipeline_args': beam_pipeline_args}
...
def main():
  ...
  additional_pipeline_args = _make_additional_pipeline_args(exec_properties)
